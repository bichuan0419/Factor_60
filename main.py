...
df = filter_df_by_date(startdate='2016-01-01',enddate='2019-04-30',df=New_Factor_df_date)
...
for i in range(len(df.index.unique()) - train_days):
    ...
    selected_features = pick_factor_within_period(startdate, enddate, New_Factor_df_date, number_factors=3)
    # selected_features = pick_factor_within_period_QuadProg(startdate, enddate, df)
